...
const ALLOWED_MODELS = new Set(['gpt-5-codex', 'o4-mini']);
...
export const ChatImpl = memo(({ description, initialMessages, storeMessageHistory, exportChat }: ChatProps) => {
  ...
  const [model, setModel] = useState(() => {
    ...
    return savedModel && ALLOWED_MODELS.has(savedModel) ? savedModel : DEFAULT_MODEL;
  });
  ...
  useEffect(() => {
    ...
    if (requestedModel && ALLOWED_MODELS.has(requestedModel) && requestedModel !== model) {
  ...
  }, [append, model, provider, searchParams, setSearchParams]);
